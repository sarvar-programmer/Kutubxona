...
import { Container, Form, InputGroup, FormControl, Row, Col, Button } from 'react-bootstrap';
    ...
    return (
        <>
            <Container className='book'>
                ...
                <Row className='d-flex g-0 library'>
                    {books.map((book, index) => (
                        <Col md={2} key={book.id} className='d-grid cards'>
                            <div className="books">
                                ...
                                <div className='about_book'>
                                    <p className='d-flex name_book'>{book.title}</p>
                                    <p className='d-flex format'>Formati: <p>{book.format}</p></p> <Button className="like" variant="light" onClick={() => toggleLike(index)}>
